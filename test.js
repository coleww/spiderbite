...
tap.test('fails if no leads are bound', function (t) {
  ...
  var spiderbite = sb({bpm: 120})
  spiderbite.bind(false, function () {}, [{}, {}])
...
//     }])
//   } catch (e) {
//     t.equal(e.message, 'too many probabilities!')
//   }
//   try {
//     spiderbite.bind(true, function () {}, [{
//       data: [
...
//     }])
//   } catch (e) {
//     t.equal(e.message, 'too many nexts!')
//   }
...
//     }])
//   } catch (e) {
//     t.equal(e.message, 'too many datas!!')
//   }
// })
...
//     }])
//   } catch (e) {
//     t.equal(e.message, 'a non-existent pattern exists as a value for next!')
//   }
// })
...
//     }])
//   } catch (e) {
//     t.equal(e.message, 'data/probs pattern mismatch')
//   }
//   try {
//     spiderbite.bind(true, function () {}, [{
//       data: [
